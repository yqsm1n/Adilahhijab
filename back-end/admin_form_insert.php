    ...
    <div class="col-lg-9 mt-5"> <!-- ขนาดการ์ด -->
            <div class="card shadow-lg border-0 rounded-lg mt-5"> <!-- ส่วนหัวข้อของการ์ด -->
                <div class="card-header">
                    <h3 style="font-family: 'Sarabun', sans-serif; font-weight: bold; color: #333; font-size: 28px; " class="text-center font-weight-light my-4">เพิ่มผู้ดูแลระบบ</h3></div>
<!-- ส่วนเนื้อหาของการ์ด -->     
                <div class="card-body"> 
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="form-floating my-3"> 
                                    ...
                                    <p style="font-family: 'Sarabun', sans-serif; font-weight: bold; color: #333; font-size: 16px; ">ที่อยู่</p>
                                        ...
                                        <div class="form-floating my-3"> 
                                        <input class="form-control" name="username_admin" input type="text" placeholder="Enter your name" />
                                        <label for=""style="font-family: 'Sarabun', sans-serif; font-weight: bold; color: #333; font-size: 16px; ">ชื่อผู้ใช้งาน</label>
                                        
                                        <div class="form-floating my-3"> 
                                        <input class="form-control" name="admin_password" input type="text" placeholder="Enter your name" />
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mt-4 mb-0 ">
                                             <button type="submit" name="save_admin" class="btn btn-primary " style="font-family: 'Sarabun', sans-serif; font-weight: bold; background-color: #35B752;  border-color: #35B752; padding: 10px 50px;">เพิ่มผู้ใช้งานระบบ</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
