...
<div class="container justify-content-center">
    <div class="row">
        <div class="col-xl-6 col-md-6">
            <div class="card mb-4">
                <div class="card-inner">
                    <p class="text-black font-weight-bold">รายการสั่งซื้อสินค้า</p>
                    <i class="fa-solid fa-cart-shopping fa-4x" style="color:#85C1E9;" ></i>
                </div>
                <h1 class="text-black font-weight-bold"><?=$row1['show_order_no']?></h1>
            </div>
        </div>
        <div class="col-xl-6 col-md-6">
            <div class="card mb-4">
                <div class="card-inner">
                    <p class="text-black font-weight-bold">ยอดขายวันนี้</p>
                    <i class="fa-solid fa-sack-dollar fa-4x" style="color: #52BE80;"></i>
                </div>
                <h1 class="text-black font-weight-bold">7,9<?=$row2['show_order_yes']?>0</h1>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-md-6">
            <div class="card mb-4">
                <div class="card-inner">
                    <p class="text-black font-weight-bold">สินค้าขายดี</p>
                    <i class="fa-solid fa-bolt-lightning fa-4x" style="color:#CB4335 ;"></i>
                </div>
                <h1 class="text-black font-weight-bold">4</h1>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-md-6">
            <div class="card mb-4">
                <div class="card-inner">
                    <p class="text-black font-weight-bold">สินค้าใกล้หมด</p>
                    <i class="fa-solid fa-bell fa-4x" style="color: #F7DC6F ;"></i>
                </div>
                <h1 class="text-black font-weight-bold">2</h1>
            </div>
        </div>
