...
<body>
    ...
    <div class="col-lg-9" style="margin: 50px;"> <!-- ขนาดการ์ด -->
            <div class="card shadow-lg border-0 rounded-lg mt-5"> <!-- ส่วนหัวข้อของการ์ด -->
                <div class="card-header">
                    <h3 style="font-family: 'Sarabun', sans-serif; font-weight: bold; color: #333; font-size: 28px; text-align: center; ">QR พร้อมเพย์</h3></div>
                    <!-- ส่วนเนื้อหาของการ์ด -->     
                <div class="card-body"> 
                <p style="text-align: center;">
                    <img src="../img/qr.jpg" width="350" height="350" style="margin-right: 5px; display: inline-block;">
                </p>
                        <form>
                            <div class="row mb-2">
                                <div class="col-md">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    ...
                                    cursor: pointer; border-radius: 12px;" onclick="location.href='insert_cart.php'">ยืนยันการชำระเงิน</button>
                                </div>
                                </div>
                        </form>
                </div>
